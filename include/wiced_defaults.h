...
#define WICED_TCP_DISCONNECT_TIMEOUT              (5000)
#define WICED_TCP_BIND_TIMEOUT                    (5000)
#define WICED_TCP_SEND_TIMEOUT                    (5000)
#define WICED_TCP_ACCEPT_TIMEOUT                  (5000)
#define WICED_UDP_BIND_TIMEOUT                    (3000)
#define WICED_TLS_RECEIVE_TIMEOUT                 (5000)
#define WICED_TLS_TRANSMIT_TIMEOUT                (5000)
#define WICED_DHCP_IP_ADDRESS_RESOLUTION_TIMEOUT (20000)
#define WICED_AUTO_IP_ADDRESS_RESOLUTION_TIMEOUT (20000)
...
/************************************************************************
 * WICED Join Options */
#define WICED_JOIN_RETRY_ATTEMPTS             (10)
