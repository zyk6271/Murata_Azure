 ...
 ******************************************************/
#ifndef BAUDRATE_UPDATE_ONLY_CHANGE_BRR
extern wiced_result_t bluetooth_wiced_init_config_uart( const platform_uart_config_t* bt_uart_config );
#else
extern wiced_result_t bluetooth_wiced_update_baudrate_uart( const platform_uart_config_t* bt_uart_config );
#endif
...
#else
    result = bluetooth_wiced_update_baudrate_uart( &bt_uart_config );
#endif /* BT_BAUDRATE_UPDATE_ONLY_BRR */
...
#else
        bluetooth_wiced_update_baudrate_uart( &bt_uart_config );
#endif /* BT_BAUDRATE_UPDATE_ONLY_BRR */
