...
platform_result_t platform_uart_update_baudrate( platform_uart_driver_t* driver, const platform_uart_t* peripheral, const platform_uart_config_t* config, wiced_ring_buffer_t* optional_ring_buffer )
{
    USART_InitTypeDef uart_init_structure;
	...
	USART_UpdateBaudrate(peripheral->port, &uart_init_structure);
