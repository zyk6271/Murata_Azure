...
// Service UUID
let WiFiIntroducerConfigNWMConfigServiceUUID    = CBUUID(string: "1B7E8251-2877-41C3-B46E-CF057C562524")
...
open class Peripheral : NSObject, CBPeripheralDelegate {
    ...
    @nonobjc open func peripheral(_:CBPeripheral!, didModifyService invalidatedServices:[CBService]!) {
