...
const char resources_apps_DIR_azure_iot_hub_DIR_rootca_cer_data[6977] = "-----BEGIN CERTIFICATE-----\r\n" \
...
"-----END CERTIFICATE-----\r\n" \
"";
const resource_hnd_t resources_apps_DIR_azure_iot_hub_DIR_rootca_cer = { RESOURCE_IN_MEMORY, 6977, { .mem = { resources_apps_DIR_azure_iot_hub_DIR_rootca_cer_data }}};
