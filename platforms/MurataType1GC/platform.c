...
const gpio_button_t platform_gpio_buttons[PLATFORM_BUTTON_MAX] =
{
    [PLATFORM_BUTTON_1] =
    {
        ...
        .config     = INPUT_HIGH_IMPEDANCE,    /* External pull ups on Cypress BCM943909WCDEVAL_2 evaluation board */
...
void platform_init_external_devices( void )
{
    ...
    platform_gpio_init( &platform_gpio_pins[ platform_gpio_buttons[PLATFORM_BUTTON_4].gpio ], platform_gpio_buttons[PLATFORM_BUTTON_4].config );
    platform_gpio_init( &platform_gpio_pins[ platform_gpio_buttons[PLATFORM_BUTTON_5].gpio ], platform_gpio_buttons[PLATFORM_BUTTON_5].config );
    platform_gpio_init( &platform_gpio_pins[ platform_gpio_buttons[PLATFORM_BUTTON_6].gpio ], platform_gpio_buttons[PLATFORM_BUTTON_6].config );
