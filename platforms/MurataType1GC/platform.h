...
#define WICED_BUTTON1    (WICED_GPIO_13)    /* BACK button on eval board */
#define WICED_BUTTON2    (WICED_GPIO_14)    /* FORWARD button on eval board */
#define WICED_BUTTON3    (WICED_GPIO_5)
#define WICED_BUTTON4    (WICED_GPIO_18)
#define WICED_BUTTON5    (WICED_GPIO_17)
#define WICED_BUTTON6    (WICED_GPIO_12)
...
#define WICED_BUTTON_BACK               ( WICED_GPIO_13 )
#define WICED_BUTTON_FORWARD            ( WICED_GPIO_14 )
