...
#  WLAN Clock Source
#  1. Ext 32kHz Clock Source -> LPO_IN pin
#  2. 32kHz Xtal -> STM32 -> MCO Clock Output -> LPO_IN pin (default)
ifdef NOUSE_32KXTAL
GLOBAL_DEFINES += SLOW_SDIO_CLOCK STM_LSE_OFF
else
GLOBAL_DEFINES += SLOW_SDIO_CLOCK MURATA_USE_32K_XTAL
endif
...
GLOBAL_DEFINES += BAUDRATE_UPDATE_ONLY_CHANGE_BRR

GLOBAL_DEFINES += MURATA_CMD
# Components
