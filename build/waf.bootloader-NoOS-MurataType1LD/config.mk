...
RESOURCE_CFLAGS               += -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\" -mthumb -mcpu=cortex-m4 -mlittle-endian
RESOURCE_CXXFLAGS             += -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\" -mthumb -mcpu=cortex-m4 -mlittle-endian
...
WICED_SDK_INCLUDES            +=                                         -I./WICED/platform/MCU/STM32F4xx/peripherals/libraries/. -I./WICED/platform/MCU/STM32F4xx/peripherals/libraries/inc -I./WICED/platform/MCU/STM32F4xx/peripherals/libraries/../../../ARM_CM4/CMSIS -I./libraries/utilities/ring_buffer/. -I./WICED/platform/MCU/STM32F4xx/peripherals/. -I./WICED/platform/GCC/. -I././WICED/platform/MCU/STM32F4xx/. -I././WICED/platform/MCU/STM32F4xx/.. -I././WICED/platform/MCU/STM32F4xx/../.. -I././WICED/platform/MCU/STM32F4xx/../../include -I././WICED/platform/MCU/STM32F4xx/../../ARM_CM4 -I././WICED/platform/MCU/STM32F4xx/../../ARM_CM4/CMSIS -I././WICED/platform/MCU/STM32F4xx/peripherals -I././WICED/platform/MCU/STM32F4xx/WAF -I./libraries/inputs/gpio_button/. -I./libraries/drivers/spi_flash/. -I././WICED/RTOS/NoOS/WWD/. -I././WICED/RTOS/NoOS/WWD/Cortex_M3_M4 -I./libraries/utilities/crc/. -I./libraries/filesystems/wicedfs/src -I././WICED/WWD/include -I././WICED/security/BESL/include -I././WICED/security/BESL/host/WICED -I././WICED/security/BESL/crypto_internal -I././WICED/security/PostgreSQL/include -I././WICED/security/BESL/mbedtls_open/include -I././WICED/. -I././WICED/platform/include -I././WICED/../libraries/test/wl_tool/43438A1/include -I././WICED/../libraries/utilities/wifi -I./platforms/MurataType1LD/. -I./platforms/MurataType1LD/./libraries/inputs/gpio_button -I./WICED/RTOS/NoOS/. -I./apps/waf/bootloader/. -I./apps/waf/bootloader/../../../libraries/utilities/linked_list -I./WICED/WWD/internal/chips/4343x -I./libraries -I./include
WICED_SDK_DEFINES             +=                                            -DSFLASH_APPS_HEADER_LOC=0x0000 -DUSE_STDPERIPH_DRIVER -D_STM3x_ -D_STM32x_ -DSTM32F412xG -DPLATFORM_SUPPORTS_LOW_POWER_MODES -DMAX_WATCHDOG_TIMEOUT_SECONDS=22 -DUSING_WICEDFS -DNO_WICED_API -DWWD_STARTUP_DELAY=10 -DBOOTLOADER_MAGIC_NUMBER=0x4d435242 -DSLOW_SDIO_CLOCK -DMURATA_USE_32K_XTAL -DWWD_DIRECT_RESOURCES -DHSE_VALUE=26000000 -DCRLF_STDIO_REPLACEMENT -DWICED_DCT_INCLUDE_BT_CONFIG -DBAUDRATE_UPDATE_ONLY_CHANGE_BRR -DMURATA_CMD -DRTOS_NoOS=1 -DWICED_NO_WIFI -DWICED_DISABLE_STDIO -DWICED_DISABLE_MCU_POWERSAVE -DWICED_DCACHE_WTHROUGH -DNO_WIFI_FIRMWARE -DBOOTLOADER -DDCT_CRC32_CALCULATION_SIZE_ON_STACK=1024 -DWICED_SDK_WIFI_CONFIG_DCT_H=\"./include/default_wifi_config_dct.h\" -DWICED_SDK_BT_CONFIG_DCT_H=\"./include/default_bt_config_dct.h\"
COMPONENTS                := App_WICED_Bootloader_MurataType1LD NoOS Platform_MurataType1LD WICED Lib_Wiced_RO_FS Lib_crc WWD_NoOS_Interface Lib_SPI_Flash_Library_MurataType1LD Lib_GPIO_button STM32F4xx common_GCC STM32F4xx_Peripheral_Drivers Lib_Ring_Buffer STM32F4xx_Peripheral_Libraries
BUS                       := SDIO
IMAGE_TYPE                := ram
NETWORK_FULL              := 
RTOS_FULL                 := NoOS
...
App_WICED_Bootloader_MurataType1LD_LOCATION         := ./apps/waf/bootloader/
...
App_WICED_Bootloader_MurataType1LD_SOURCES          += bootloader.c
NoOS_SOURCES          += 
...
App_WICED_Bootloader_MurataType1LD_CHECK_HEADERS    += 
NoOS_CHECK_HEADERS    += 
...
App_WICED_Bootloader_MurataType1LD_INCLUDES         := 
NoOS_INCLUDES         := 
...
App_WICED_Bootloader_MurataType1LD_DEFINES          := 
NoOS_DEFINES          := 
...
App_WICED_Bootloader_MurataType1LD_CFLAGS           := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          
NoOS_CFLAGS           := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          
Platform_MurataType1LD_CFLAGS           := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          
WICED_CFLAGS           := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu11 -fdiagnostics-color  -Werror -Wstrict-prototypes  -W -Wshadow  -Wwrite-strings -pedantic -std=c11 -U__STRICT_ANSI__ -Wconversion -Wextra -Wdeclaration-after-statement -Wconversion -Waddress -Wlogical-op -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-declarations -Wmissing-field-initializers -Wdouble-promotion -Wswitch-enum -Wswitch-default -Wuninitialized -Wunknown-pragmas -Wfloat-equal  -Wundef  -Wshadow 
Lib_Wiced_RO_FS_CFLAGS           := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu11 -fdiagnostics-color  -Werror -Wstrict-prototypes  -W -Wshadow  -Wwrite-strings -pedantic -std=c11 -U__STRICT_ANSI__ -Wconversion -Wextra -Wdeclaration-after-statement -Wconversion -Waddress -Wlogical-op -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-declarations -Wmissing-field-initializers -Wdouble-promotion -Wswitch-enum -Wswitch-default -Wuninitialized -Wunknown-pragmas -Wfloat-equal  -Wundef  -Wshadow 
Lib_crc_CFLAGS           := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          
WWD_NoOS_Interface_CFLAGS           := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu11 -fdiagnostics-color  -Werror -Wstrict-prototypes  -W -Wshadow  -Wwrite-strings -pedantic -std=c11 -U__STRICT_ANSI__ -Wconversion -Wextra -Wdeclaration-after-statement -Wconversion -Waddress -Wlogical-op -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-declarations -Wmissing-field-initializers -Wdouble-promotion -Wswitch-enum -Wswitch-default -Wuninitialized -Wunknown-pragmas -Wfloat-equal  -Wundef  -Wshadow 
Lib_SPI_Flash_Library_MurataType1LD_CFLAGS           := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu11 -fdiagnostics-color  -Werror -Wstrict-prototypes  -W -Wshadow  -Wwrite-strings -pedantic -std=c11 -U__STRICT_ANSI__ -Wconversion -Wextra -Wdeclaration-after-statement -Wconversion -Waddress -Wlogical-op -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-declarations -Wmissing-field-initializers -Wdouble-promotion -Wswitch-enum -Wswitch-default -Wuninitialized -Wunknown-pragmas -Wfloat-equal  -Wundef  -Wshadow 
Lib_GPIO_button_CFLAGS           := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu11 -fdiagnostics-color  -Werror -Wstrict-prototypes  -W -Wshadow  -Wwrite-strings -pedantic -std=c11 -U__STRICT_ANSI__ -Wconversion -Wextra -Wdeclaration-after-statement -Wconversion -Waddress -Wlogical-op -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-declarations -Wmissing-field-initializers -Wdouble-promotion -Wswitch-enum -Wswitch-default -Wuninitialized -Wunknown-pragmas -Wfloat-equal  -Wundef  -Wshadow 
STM32F4xx_CFLAGS           := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu11 -fdiagnostics-color  -Werror -Wstrict-prototypes  -W -Wshadow  -Wwrite-strings -pedantic -std=c11 -U__STRICT_ANSI__ -Wconversion -Wextra -Wdeclaration-after-statement -Wconversion -Waddress -Wlogical-op -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-declarations -Wmissing-field-initializers -Wdouble-promotion -Wswitch-enum -Wswitch-default -Wuninitialized -Wunknown-pragmas -Wfloat-equal  -Wundef  -Wshadow 
common_GCC_CFLAGS           := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          
STM32F4xx_Peripheral_Drivers_CFLAGS           := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          
Lib_Ring_Buffer_CFLAGS           := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          
STM32F4xx_Peripheral_Libraries_CFLAGS           := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4    -mlittle-endian          
App_WICED_Bootloader_MurataType1LD_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
NoOS_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
Platform_MurataType1LD_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
WICED_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
Lib_Wiced_RO_FS_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
Lib_crc_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
WWD_NoOS_Interface_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
Lib_SPI_Flash_Library_MurataType1LD_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
Lib_GPIO_button_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
STM32F4xx_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
common_GCC_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
STM32F4xx_Peripheral_Drivers_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
Lib_Ring_Buffer_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
STM32F4xx_Peripheral_Libraries_CXXFLAGS         := -DWICED_VERSION=\"Wiced_006.006.000.0009\" -DBUS=\"$(BUS)\" -Ibuild/waf.bootloader-NoOS-MurataType1LD/resources/ -DPLATFORM=\"$(PLATFORM)\" -DAPPS_CHIP_REVISION=\"$(APPS_CHIP_REVISION)\"     -mthumb -mcpu=cortex-m4  -mlittle-endian          
App_WICED_Bootloader_MurataType1LD_ASMFLAGS         :=     -mcpu=cortex-m4 -mfpu=softvfp  -mlittle-endian          
...
App_WICED_Bootloader_MurataType1LD_RESOURCES        := 
NoOS_RESOURCES        := 
...
App_WICED_Bootloader_MurataType1LD_MAKEFILE         := ./apps/waf/bootloader/bootloader.mk
...
App_WICED_Bootloader_MurataType1LD_PRE_BUILD_TARGETS:= 
...
App_WICED_Bootloader_MurataType1LD_PREBUILT_LIBRARY := 
...
App_WICED_Bootloader_MurataType1LD_BUILD_TYPE       := release
