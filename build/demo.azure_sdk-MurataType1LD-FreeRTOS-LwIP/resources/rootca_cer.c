...
const char resources_apps_DIR_azure_iot_hub_DIR_rootca_cer_data[5662] = "-----BEGIN CERTIFICATE-----\r\n" \
...
"-----END CERTIFICATE-----";
const resource_hnd_t resources_apps_DIR_azure_iot_hub_DIR_rootca_cer = { RESOURCE_IN_MEMORY, 5661, { .mem = { resources_apps_DIR_azure_iot_hub_DIR_rootca_cer_data }}};
